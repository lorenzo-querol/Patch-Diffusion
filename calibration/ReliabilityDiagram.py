...
from .metrics.Miscalibration import _Miscalibration
...
class ReliabilityDiagram(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._miscalibration = _Miscalibration(bins=bins, equal_intervals=equal_intervals, detection=detection, sample_threshold=sample_threshold)
    ...
    def plot(
        ...
        **save_args : args
        ...
        for batch_X, batch_matched, batch_uncertainty, bounds in zip(X, matched, sample_uncertainty, bin_bounds):
            ...
            batch_histograms, batch_num_samples, _, _ = self._miscalibration.binning(bounds, batch_X, batch_matched, batch_X[:, 0], batch_uncertainty[:, 0])
    ...
    def __plot_confidence_histogram(
        ...
        mean_acc, mean_conf = [], []
        for batch_X, batch_matched, batch_hist, batch_num_samples, batch_median in zip(X, matched, histograms, num_samples_hist, median_confidence):
        ...
        ax.bar(median_confidence, height=acc, width=bar_width, align="center", edgecolor="black", yerr=uncertainty, capsize=4)
        ax.bar(median_confidence, height=deviation, bottom=acc, width=bar_width, align="center", edgecolor="black", color="red", alpha=0.6)
    ...
    def __plot_1d(
        ...
        ax1.legend((line1, line2, line3), ("accuracy", "confidence", "%s" % self.metric.upper()), loc="best")
