...
class ECE(_Miscalibration):
    ...
    def measure(
        ...
        return self._measure(
            X=X, y=y, metric="ece", batched=batched, uncertainty=uncertainty, return_map=return_map, return_num_samples=return_num_samples, return_uncertainty_map=return_uncertainty_map
        )
