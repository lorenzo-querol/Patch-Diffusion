...
class SongUNet(torch.nn.Module):
    ...
    def forward(self, x, noise_labels, class_labels, augment_labels=None, cls_mode=False):
    ...
    def __init__(
        ...
        **model_kwargs,  # Keyword arguments for the underlying model.
        ...
        self.model = globals()[model_type](
            img_resolution=img_resolution, in_channels=img_channels, out_channels=img_channels, label_dim=label_dim, **model_kwargs
        )
...
class iDDPMPrecond(torch.nn.Module):
    def __init__(
        ...
        **model_kwargs,  # Keyword arguments for the underlying model.
        ...
        self.M = M
        self.model = globals()[model_type](
            img_resolution=img_resolution, in_channels=img_channels, out_channels=img_channels * 2, label_dim=label_dim, **model_kwargs
        )
